import type { Activity, LeagueDetail, News, LeagueRow, LineupSuggestion, NflState, WaiverTarget } from './types'
...
export const api = {
  ...
  news: (days: number, bench: boolean) => get<News>(`/api/news?days=${days}&bench=${bench}`),
